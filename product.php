    ...
    <div class="container">
        ...
        <div class="formbox shadow-lg p-4">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="pname" id="pn" placeholder="Enter product name:" required>
                <span id="pninvalid"></span>
            </div>
            <div class="mb-3">
                <label for="" class="form-label">Product Description :</label>
                <textarea class="form-control" name="pdesc" id="pd" cols="30" rows="4"></textarea>
                <span id="pdinvalid"></span>
            </div>
